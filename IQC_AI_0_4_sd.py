...
n_error = len(np.arange(0,4.25,0.25))
for k in np.arange(0,4.25,0.25):
    k_list = np.ones(N)*k
...
# tek data frame de birleştirdim.

export_excel= table_w_frames.to_excel(r"/Users/hikmetcancubukcu/Desktop/IQCAI çalışma/IQCAI_0_4sd_sonuc_025_10000.xlsx", index= None, header= True)
